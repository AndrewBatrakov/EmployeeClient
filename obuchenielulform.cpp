...
ObuchenieLulForm::ObuchenieLulForm(QString id, QWidget *parent, bool onlyForRead) : QDialog(parent)
{
...
void ObuchenieLulForm::done(int result)
{
    writeSettings();
    QDialog::done(result);
}

void ObuchenieLulForm::saveRecord()
{
    editRecord();
    emit accept();
}

void ObuchenieLulForm::cancelRecord()
{
...
void ObuchenieLulForm::editRecord()
{
    QTextStream stream(&exchangeFile);
    QString line;
    while(!stream.atEnd()){
...
void ObuchenieLulForm::deleteRecord()
{
    QTextStream stream(&exchangeFile);
    QString line;
    while(!stream.atEnd()){
...
void ObuchenieLulForm::readSettings()
{
    QSettings settings("AO_Batrakov_Inc.", "EmployeeClient");
    restoreGeometry(settings.value("ObuchLulForm").toByteArray());
}

void ObuchenieLulForm::writeSettings()
{
    QSettings settings("AO_Batrakov_Inc.", "EmployeeClient");
    settings.setValue("ObuchLulForm", saveGeometry());
}

void ObuchenieLulForm::addRecordOfTable()
{
    if(checkingFill()){
        QTextStream stream(&exchangeFile);
        QString line;
...
void ObuchenieLulForm::deleteRecordOfTable()
{
    QTextStream stream(&exchangeFile);
    QString line;
    while(!stream.atEnd()){
...
void ObuchenieLulForm::editRecordOfTable()
{
    QMessageBox::warning(this,"Attention!!!","You are not able to edit!");
}

bool ObuchenieLulForm::checkingFill()
{
    bool fill = true;
    if(editDogovor->text() == ""){
...
void ObuchenieLulForm::updateTable()
{
...
void ObuchenieLulForm::printTable()
{
...
int ObuchenieLulForm::printParagraph(QString paragraphString, QPainter *painter, QRect *rect, int spacing)
{
...
void ObuchenieLulForm::print(QPrinter *printer)
{
...
void ObuchenieLulForm::excelExport()
{
