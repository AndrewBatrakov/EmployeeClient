...
void ObuchenieVisForm::editRecord()
{
    ...
    if(queryIns.isValid()){
        ...
        stream<<line;
        if(!query.isActive()){
            QMessageBox::warning(this,QObject::tr("Obuch Vis, UPDATE ERROR!"),query.lastError().text());
            return;
        }
    }else{
        ...
        if(!queryInsert.isActive()){
            QMessageBox::warning(this,QObject::tr("Obuch Vis, INSERT ERROR!"),queryInsert.lastError().text());
            return;
        }
    }
}
        ...
        while(query.next()){
            ...
            if(insert){
                ...
                if(!queryPSL.isActive()){
                    QMessageBox::warning(this,QObject::tr("Obuch Vis List Table, INSERT ERROR!"),queryPSL.lastError().text());
                    return;
                }
...
void ObuchenieVisForm::deleteRecordOfTable()
{
    ...
    if(k == QMessageBox::Yes){
        ...
        if(!query.isActive()){
            QMessageBox::warning(this,QObject::tr("Obuch Vis Table, DELETE ERROR!"),
