...
void ProtocolLaborprotectionForm::printUd(QPrinter *printer)
{
    ...
    QRect rectStrD(270,200,2160,100);
    ...
    painter.drawLine(2700,400,4590,400);
    ...
    painter.drawLine(2970,600,4590,600);
    ...
    painter.drawLine(2970,800,4590,800);
