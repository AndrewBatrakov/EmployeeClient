#ifndef OBUCHENIEVISFORM_H
#define OBUCHENIEVISFORM_H
...
class ObuchenieVisForm : public QDialog
{
    Q_OBJECT

public:
    ObuchenieVisForm(QString, QWidget *, bool);
...
private:
    ...
    QLabel *labelGruppaObuch;
    LineEdit *editGruppaObuch;
